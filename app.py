...
def main():
    ...
    if choice == "Summary":
        html_temp = """
	<div style="background-color:#16a099;"><p style="color:white;font-size:60px;">Text Summarizer</p></div>
	"""
        components.html(html_temp)
        text_range= st.sidebar.slider("Summarize words Range",30,500)
    ...
    # Tokenizer 
        ...
        html_temp1 = """
	<div style="background-color:#16a099;"><p style="color:white;font-size:60px;">Text Tokenizer</p></div>
	"""
    ...
    # synonyms      
        ...
        html_temp2 = """
	<div style="background-color:#16a099;"><p style="color:white;font-size:60px;">Words Synonyms</p></div>
	""" 
    ...
    # Translator          
        ...
        html_temp3 = """
	<div style="background-color:#16a099;"><p style="color:white;font-size:60px;">Text Translator</p></div>
	""" 
    ...
    # Search Bar
        ...
        html_temp4 = """
	<div style="background-color:#16a099;"><p style="color:white;font-size:60px;,text-align:center;">Search Bar</p></div>
	""" 
    ...
    # Spelling Correction
        ...
        html_temp6 = """
	<div style="background-color:#16a099;"><p style="color:white;font-size:60px;">Spell Correction</p></div>
	"""
	...
	"""
        ...
        html_temp8 = """
	<div style="background-color:#16a099;"><p style="color:white;font-size:60px;,text-align:center;">comparative & superlative</p></div>
	""" 
